...
- **v0.6.1 — released on PyPI** (2026-06-28). Test-suite hardening, no runtime or API change (the wheel is identical to v0.6.0): the parity-oracle fixtures are now SHA-pinned, the default test run is fully offline, and several tests were tightened to catch regressions they previously couldn't.
