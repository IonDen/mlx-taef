...
TAEF1 = ModelKernel(
    ...
    integration=MfluxBinding(
        # mflux 0.19.1 aliases of every FLUX.1 model (they share the FLUX.1 VAE latent).
        mflux_models=(
            "dev",
            "schnell",
            "dev-kontext",
        ...
        mflux_model_name_prefixes=("black-forest-labs/FLUX.1-",),
    ),
...
TAEF2 = ModelKernel(
    ...
    integration=MfluxBinding(
        ...
        packed_latent_downscale=16,
        mflux_model_name_prefixes=("black-forest-labs/FLUX.2-klein",),
    ),
